  ...
  <section class="my-cart-container">
    ...
    <form action="../php/checkout.php" method="POST">
          <?php 
            ...
            <tr>
                <td> <input type="checkbox" name="cart[]" id="<?=$cartRow['CARTID']?>" class="cart" value="<?=$cartRow['CARTID']?>"> </td>
...
<script>
    var id = document.getElementById('<?=$cID?>').checked = true;
</script>
