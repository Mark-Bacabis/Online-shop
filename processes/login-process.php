<?php
    ...
    if(isset($_POST['register-btn'])){
        ...
        $ins = oci_parse($connection, "INSERT INTO customeracc (USERID, FIRSTNAME, LASTNAME, PROFILEPIC, ADDRESS, EMAIL, PASS, ZIP) VALUES ($custID, '$firstname','$lastname','default-profile.jpg','$address', '$emailadd', '$password', $zip)
        ");
