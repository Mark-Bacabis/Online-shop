    ...
    <!-- PRODUCT IMAGES AND INFO -->
      ...
      <div class="product-container product-info-details">
          ...
          <div class="product-quantity">
              <form action="../processes/buy-process.php" method="POST">
          ...
          <div class="function-button">
                <button type = "button" class="add-to-cart"> Add to cart </button> <br>
                <button type = "submit" name = "buy-btn" class="buy-now"> Buy now </button>
          </div>
          </form>
      </div>
    <!-- PRODUCT IMAGES AND INFO -->
